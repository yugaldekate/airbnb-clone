...
const Modal : React.FC<ModalProps> = ({ title, isOpen, disabled, actionLabel, body, footer, secondaryActionLabel, onClose, onSubmit, secondaryAction}) => {
    ...
    return (
        <>
            <div className="fixed inset-0 z-50 flex justify-center items-center overflow-x-hidden outline-none focus:outline-none bg-neutral-800/70">
                <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto">
                    ...
                    >
                        <div className="translate relative flex flex-col w-full overflow-y-auto h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg bg-white outline-none focus:outline-none">
                            {/*header*/}
